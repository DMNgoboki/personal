  ...
  return (
    <div>
      <div className=" flex mt-[50px] justify-center">
        <div className="font-extrabold text-black text-5xl lg:text-7xl">CONTACT</div>
      </div>
      <div className="flex mt-[40px] px-[20px] w-full gap-8 justify-center">
        <div>
          <div className="flex font-anton text-black justify-center text-4xl lg:text-5xl">
            SOCIAL
          </div>
          <div className="text-5xl font-extrabold flex flex-col text-center lg:grid grid-rows-2 grid-flow-col gap-8 mt-[50px] mb-[40px]">
            <Link
      ...
      <div className="flex font-anton justify-center bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-blue-400 ">
        <TestAnimation />
      </div>
    </div>
  );
