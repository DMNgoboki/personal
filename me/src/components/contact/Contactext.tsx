  ...
  return (
    <div>
      <div className="container font-honk mx-auto text-black bg-white">
        ...
        <div className="flex mt-[80px] px-[20px] w-full gap-8 justify-center">
          <div>
            <div className="flex font-extrabold  justify-center text-5xl">
              Social
            </div>
            <div className="text-5xl font-extrabold grid grid-rows-2 grid-flow-col gap-8 mt-[90px] mb-[80px]">
              <Link
